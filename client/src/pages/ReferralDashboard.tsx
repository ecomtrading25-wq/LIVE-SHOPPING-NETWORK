      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <Card className="p-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-purple-500/30 mb-8">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h3 className="text-xl font-bold text-white mb-1">Your Referral Link</h3>
          ...
          <div className="flex gap-2 mb-4">
            <div className="flex-1 relative">
              ...
              <Input
                value={referralLink}
                readOnly
                className="pl-10 bg-white/10 border-white/20 text-white font-mono"
              />
            </div>
            <Button
        ...
        <Card className="p-6 bg-white/5 border-white/10 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-white mb-2">2. They Sign Up</h4>
              <p className="text-sm text-gray-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-white/5 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-white">Bronze</h4>
              </div>
