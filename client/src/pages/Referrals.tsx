    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-zinc-900 to-black py-12">
        <div className="container mx-auto px-4">
          <Card className="max-w-md mx-auto p-8 bg-zinc-900/50 border-zinc-800 text-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-zinc-900 to-black py-12">
      <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="flex gap-3 mb-6">
              <Input
                ...
                value={referralLink}
                readOnly
                className="flex-1 bg-white/20 border-white/30 text-white text-lg font-mono"
              />
              <Button
        ...
        {/* How It Works */}
        <Card className="p-8 bg-zinc-900/50 border-zinc-800 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Earn 10% Commission</h3>
              <p className="text-gray-400">
