        ...
        <Card className="p-4 bg-zinc-900 border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-white">{stats?.openDisputes || 0}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4 bg-zinc-900 border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-white">{stats?.aiResolved || 0}</p>
            </div>
          </div>
        </Card>
      </div>
        ...
        <Table>
          ...
          <TableBody>
            {disputes?.map((dispute) => (
              <TableRow key={dispute.id} className="border-zinc-800 hover:bg-zinc-800/50">
                <TableCell className="font-mono text-sm text-gray-300">
                  {dispute.id.substring(0, 8)}
                </TableCell>
                <TableCell className="text-white font-medium">#{dispute.orderId}</TableCell>
                <TableCell className="text-gray-300">{dispute.customerName}</TableCell>
                  ...
                  <div className="flex gap-2">
                    <Dialog>
                      ...
                      <DialogContent className="bg-zinc-900 border-zinc-800 max-w-2xl">
                        <DialogHeader>
                          <DialogTitle className="text-white">AI Dispute Resolution</DialogTitle>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4 bg-zinc-800 border-zinc-700">
        ...
        <p className="text-gray-300 text-sm">{resolution.analysis}</p>
      </Card>
      ...
      {resolution.evidenceRequired && resolution.evidenceRequired.length > 0 && (
        <Card className="p-4 bg-zinc-800 border-zinc-700">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-white">Evidence Required</h3>
          </div>
      ...
      <Card className="p-4 bg-zinc-800 border-zinc-700">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-bold text-white">Generated Response</h3>
        </div>
        <Textarea
